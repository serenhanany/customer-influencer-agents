...
CUSTOMER_SUPPORT_URL = os.getenv("") # TODO : put url in .env so this works
    ...
    config = AgentConfig.from_env(
        ...
        mcp_servers={
            "social": MCPServerConfig(
                ...
                requires_login=True,
                login_name="Larry",
                allowed_tools=["login", "get_global_feed", "search", "create_post", "add_comment"], # TODO ADD ALL
            ),
            ...
            "customer_support": MCPServerConfig(
                ...
                allowed_tools=["get_overview", "get_trends"], # TODO: add these
            ),
        },
    )
